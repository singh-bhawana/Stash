      ...
      <div className="relative z-10" style={{ color: HSL_COLOR.text_primary }}>
        ...
        <div className="flex flex-col items-center justify-center pt-14 pb-10">
          ...
          <span
            ...
            style={{
              background: "linear-gradient(90deg,#5f2eea,#ff61a6)",
          ...
          <button className="bg-gradient-to-r from-pink-400 to-blue-400 text-white px-6 py-2 rounded-full shadow transition hover:scale-105">
            Explore
          </button>
        </div>
        {/* --- HERO SECTION END --- */}
